...
# Tableau des moyennes des durées d'une méthode de rangement contre une autre, sans symétriques (10mn)
...
for i, rang_j1 in enumerate(methodes_rangement):
    for j, rang_j2 in enumerate(methodes_rangement):
        if i <= j:  # Exclure les symétriques
            moyenne_duree,_,_ = simuler_plusieurs(nb_couleurs=4, nb_valeurs=8, nb_parties=100000, rangement_j1=rang_j1, rangement_j2=rang_j2, trace=False)
...
# Tableau des moyennes de durées pour C=1 (45 mn)
...
# Tableau des moyennes de durées pour C=4 (45mn)
